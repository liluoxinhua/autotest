...
public class uiHelper {
    ...
    public static UiObject2 getUiObject2ByResourceID(String id) {
    ...
    public static UiObject getuiObjectByText(String text) {
        return mDevice.findObject(new UiSelector().text(text));
    }

    public static UiObject2 getUiObeject2ByResourceIdAndTextContains(String id, String text) {
        return mDevice.findObject(By.res(id).textContains(text));
    }
    ...
    /**
     * com.example.cherrylixh.ottatvtest.uiHelper.ShellUtils
     * <ul>
